...
declare class TRASHCLASS_Landscape_Manage_Mode_2 { 
	constructor();
	constructor(Outer: UObject);
	static Load(ResourceName: string): TRASHCLASS_Landscape_Manage_Mode_2;
	static Find(Outer: UObject, ResourceName: string): TRASHCLASS_Landscape_Manage_Mode_2;
	static StaticClass: any;
	static GetClassObject(): UClass;
	static GetDefaultObject(): TRASHCLASS_Landscape_Manage_Mode_2;
	static GetDefaultSubobjectByName(Name: string): UObject;
	static SetDefaultSubobjectClass(Name: string): void;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): TRASHCLASS_Landscape_Manage_Mode_2;
	static C(Other: UObject): TRASHCLASS_Landscape_Manage_Mode_2;
}
