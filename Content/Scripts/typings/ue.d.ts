...
declare class entity_base extends Actor { 
	...
	static C(Other: UObject | any): entity_base;
}
...
declare class bowling_pin extends entity_base { 
	...
	static C(Other: UObject | any): bowling_pin;
}

declare type ScoreType = 'FirstThrow' | 'SecondThrow' | 'NativeScore' | 'AbsoluteNativeScore' | 'AbsoluteScore';
...
declare type EndgameType = 'Undetermined' | 'DefaultEnding' | 'SpareEnding' | 'StrikeEnding';
...
declare class bowling_system extends Actor { 
	...
	static C(Other: UObject | any): bowling_system;
}
...
declare class entity_launcher extends entity_base { 
	...
	static C(Other: UObject | any): entity_launcher;
}

declare type FilterMode = 'Normal' | 'Inverted' | 'Random';
declare var FilterMode : { Normal:'Normal',Inverted:'Inverted',Random:'Random', };
declare type FilterType = 'ByClass' | 'ByName' | 'ByTag' | 'ByIsVisible' | 'ByIsSolid' | 'ByIsPhysicsSimulated';
...
declare class filter_base extends Actor { 
	...
	static C(Other: UObject | any): filter_base;
}
...
declare class info_hudhint extends Actor { 
	...
	static C(Other: UObject | any): info_hudhint;
}
...
declare class info_target extends Actor { 
	...
	static C(Other: UObject | any): info_target;
}
...
declare class info_target_character extends info_target { 
	...
	static C(Other: UObject | any): info_target_character;
}
...
declare class prop_move_base extends entity_base { 
	...
	Close(): void;
	static C(Other: UObject | any): prop_move_base;
}
...
declare class prop_movelinear extends prop_move_base { 
	...
	IsClosed(): boolean;
	GetEstimatedTravelTime(): number;
	static C(Other: UObject | any): prop_movelinear;
}
...
declare class prop_rotator extends prop_move_base { 
	...
	IsOpen(): boolean;
	IsClosed(): boolean;
	static C(Other: UObject | any): prop_rotator;
}
...
declare class prop_rotator_pivoted extends prop_rotator { 
	...
	static C(Other: UObject | any): prop_rotator_pivoted;
}
...
declare class prop_worldbutton extends prop_movelinear { 
	...
	Press(): void;
	OnPressed(): void;
	static C(Other: UObject | any): prop_worldbutton;
}
...
declare class util_debug extends Actor { 
	...
	static C(Other: UObject | any): util_debug;
}
...
declare class worldui_base extends entity_base { 
	...
	static C(Other: UObject | any): worldui_base;
}
...
declare class worldui_sprite extends worldui_base { 
	...
	static C(Other: UObject | any): worldui_sprite;
}
...
declare class worldui_text extends TextRenderActor { 
	...
	static C(Other: UObject | any): worldui_text;
}
